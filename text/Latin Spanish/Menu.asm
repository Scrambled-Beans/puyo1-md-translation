...
Menu_Stages:
		  ...
		  Set_of_Sprites	11					
			...
			Sprite_Piece	PAL_1, $250, High, 128,  2, No, No, Pixels_8,  Pixels_32, 1
			
			Sprite_Piece	PAL_1, $254, High,  0,  34, No, No, Pixels_32, Pixels_16, 1
			Sprite_Piece	PAL_1, $25C, High, 32,  34, No, No, Pixels_32, Pixels_16, 1
			Sprite_Piece	PAL_1, $264, High, 64,  34, No, No, Pixels_32, Pixels_16, 1
			Sprite_Piece	PAL_1, $26C, High, 96,  34, No, No, Pixels_32, Pixels_16, 1
			Sprite_Piece	PAL_1, $274, High, 128, 34, No, No, Pixels_8,  Pixels_16, 1
			
					even	

; ---------------------------------------------------------------------------------	

Mode1_X:			equ 10		; Mode 1 - X Position
Mode1_Y:			equ 11		; Mode 1 - Y Position	
Mode1_Width:		equ 23		; Mode 1 - Width
Mode1_Height:		equ 2		; Mode 1 - Height	

Mode2_X:			equ 10		; Mode 2 - X Position
Mode2_Y:			equ 14		; Mode 2 - Y Position	
Mode2_Width:		equ 21		; Mode 2 - Width
Mode2_Height:		equ 2		; Mode 2 - Height

Mode3_X:			equ 10		; Mode 3 - X Position
Mode3_Y:			equ 17		; Mode 3 - Y Position	
Mode3_Width:		equ 22		; Mode 3 - Width
Mode3_Height:		equ 2		; Mode 3 - Height

Mode4_X:			equ 14		; Mode 4 - X Position
Mode4_Y:			equ 20		; Mode 4 - Y Position	
Mode4_Width:		equ 15		; Mode 4 - Width
